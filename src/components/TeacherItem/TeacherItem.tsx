            ...
            <div className="rounded-lg">
              <div className="relative flex h-60 justify-center overflow-hidden rounded-lg">
                <div className="w-full transform transition-transform duration-500 ease-in-out hover:scale-110">
                  <img src="https://iowacapitaldispatch.com/wp-content/uploads/2023/03/math-teacher-at-blackboard-1024x680.jpg" alt="" />
                </div>
              ...
              <div className="">
                <div className="mt-4 grid grid-cols-2">
                  <div className="flex items-center">
                    <div className="relative">
                      <h2 className="line-clamp-1 text-xl font-bold text-gray-800 md:text-lg" title="Name">{data['name']}</h2>
                ...
                <div className="mt-2 grid grid-cols-2 grid-rows-1 gap-4 border-b border-t border-gray-200 pb-3 pt-3">
                  <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                    <svg className="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4" viewBox="0 0 512 512">
                  ...
                  <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                    <svg className="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
